// Centralised SVG icon library — all icons are 24×24 stroke-based (Heroicons outline style)
...
export function PlusCircleIcon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
...
export function AcademicCapIcon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
...
export function ExclamationTriangleIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
...
export function Bars3Icon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
...
export function AppleIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 384 512" fill="currentColor">
      <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-27.1-46.9-42.2-83.7-45.3-35.3-3-73.8 20.6-88.2 20.6-15.2 0-49-19.6-76-19.4C82.4 140.3 45 162 24.2 196.4c-43 70.1-11 174.1 30.3 231.1 20.5 27.8 44.3 59 75.6 57.9 30.6-1.2 42-19.5 79-19.5 36.5 0 47 19.5 79.3 18.9 32.7-.6 53.2-28.2 73.3-56.2 14.8-21.6 26.1-44.3 31.2-56.5-0.7-.3-60.2-23.2-60.2-91.4zm-56.5-167.7c16.7-20.3 28-48.7 24.9-76.9-24.1 1-53.3 16-70.6 36.1-15.6 17.8-29.3 46.6-25.6 74 26.8 2.1 54.2-13.6 71.3-33.2z" />
    </svg>
  );
}
...
export function DevicePhoneIcon({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor">
